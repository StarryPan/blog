<?php /*a:1:{s:56:"C:\xampp\htdocs\git\blog\app\Index\view\index\index.html";i:1677768453;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
...
<link rel="stylesheet" href="/static/index/css/basic.css" />
<link rel="stylesheet" href="/static/index/css/layout.css" />
<link rel="stylesheet" href="/static/index/css/blogs.css" />
<link rel="stylesheet" href="/static/index/css/line-awesome.css" />
<link rel="stylesheet" href="/static/index/css/magnific-popup.css" />
<link rel="stylesheet" href="/static/index/css/animate.css" />
<link rel="stylesheet" href="/static/index/css/simplebar.css" />

<!-- theme colors -->
<!-- <link rel="stylesheet" href="/static/index/css/theme-colors/green.css" /> -->
<!-- <link rel="stylesheet" href="/static/index/css/theme-colors/blue.css" /> -->
<!--<link rel="stylesheet" href="/static/index/css/theme-colors/red.css" />-->
<link rel="stylesheet" href="/static/index/css/theme-colors/orange.css" />
<!--<link rel="stylesheet" href="/static/index/css/theme-colors/pink.css" />-->
<!--<link rel="stylesheet" href="/static/index/css/theme-colors/purple.css" />-->
				...
				<div class="vertical-center">
					...
					<div class="subtitle">
						...
						<div class="typing-title">
							<p>一个 <strong>后端 开发人员.</strong></p>
							<p>一个 <strong>web 开发人员.</strong></p>
							<p>一个 <strong>互联网民工.</strong></p>
							<p>一个 <strong>摄影爱好者.</strong></p>
						</div>
		...
		<div class="card-inner" id="about-card">
			<div class="row card-container">
				...
				<div class="card-wrap col col-m-12 col-t-12 col-d-8 col-d-lg-6" data-simplebar>
					...
					<!-- About Image -->
					<div class="card-image col col-m-12 col-t-12 col-d-4 col-d-lg-6" style="background-image: url(/static/index/images/profile.jpg);"></div>
						...
						<div class="row">
							<div class="col col-m-12 col-t-12 col-d-12 col-d-lg-12">
								...
								<div class="circle-bts">
									<a href="#"><span><i class="icon la la-download"></i>下载简历</span></a>
		...
		<div class="card-inner" id="resume-card">
			<div class="row card-container">
				...
				<div class="card-wrap col col-m-12 col-t-12 col-d-8 col-d-lg-6" data-simplebar>
					...
					<!-- Resume Image -->
					<div class="card-image col col-m-12 col-t-12 col-d-4 col-d-lg-6" style="background-image: url(/static/index/images/profile2.jpg);"></div>
		...
		<div class="card-inner" id="works-card">
			<div class="row card-container">
				...
				<div class="card-wrap col col-m-12 col-t-12 col-d-8 col-d-lg-6" data-simplebar>
					...
					<!-- Work Image -->
					<div class="card-image col col-m-12 col-t-12 col-d-4 col-d-lg-6" style="background-image: url(/static/index/images/profile3.jpg);"></div>
						...
						<div class="row grid-items">
							...
							<div class="col col-m-12 col-t-6 col-d-6 col-d-lg-6 grid-item photo">
								<div class="box-item card-box">
									...
									<div class="desc">
										<a href="/static/index/images/works/work1.jpg" class="name has-popup-image">Motorcycle Helmet</a>
							...
							<div class="col col-m-12 col-t-6 col-d-6 col-d-lg-6 grid-item photo">
								<div class="box-item card-box">
									...
									<div class="desc">
										<a href="/static/index/images/works/work5.jpg" class="name has-popup-image">Gereal Travels</a>
										<div class="category">Photo</div>
									</div>
								</div>
							</div>
		...
		<div class="card-inner" id="blog-card">
			<div class="row card-container">
				...
				<div class="card-wrap col col-m-12 col-t-12 col-d-8 col-d-lg-6" data-simplebar>
					...
					<!-- Blog Image -->
					<div class="card-image col col-m-12 col-t-12 col-d-4 col-d-lg-6" style="background-image: url(/static/index/images/profile4.jpg);"></div>
		...
		<div class="card-inner" id="contacts-card">
			<div class="row card-container">
				...
				<div class="card-wrap col col-m-12 col-t-12 col-d-8 col-d-lg-6" data-simplebar>
					...
					<!-- Map -->
					<div class="card-image col col-m-12 col-t-12 col-d-4 col-d-lg-6" style="background-image: url(/static/index/images/profile5.jpg);">
...
<script src="/static/index/js/jquery.magnific-popup.js"></script>
<script src="/static/index/js/imagesloaded.pkgd.js"></script>
<script src="/static/index/js/masonry.pkgd.js"></script>
<script src="/static/index/js/masonry-filter.js"></script>
<script src="/static/index/js/simplebar.js"></script>
<script src="/static/index/js/typed.js"></script>
